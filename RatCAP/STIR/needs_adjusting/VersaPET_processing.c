...
#define N_DET                 192 // VersaPET: Detectors per ring
#define S_WIDTH               191 // VersaPET: Number of radial sinogram bins
...
//#####################################################################
  ...
  FILE * file=fopen("crystalids.txt","w");
