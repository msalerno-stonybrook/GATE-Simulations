...
// RatCAP Parameters
#define N_RINGS                12 // RatCAP: Number of rings
#define N_SEG                  31 // RatCAP: Number of segments (2 * N_RINGS - 1)
#define N_DET                 216 // RatCAP: Detectors per ring
#define S_WIDTH               215 // RatCAP: Number of radial sinogram bins
#define N_RSEC                 24 // RatCAP: Number of rsector
#define N_MODULE                4 // RatCAP: Number of modules 1x4
#define N_MOD_xy                1 // RatCAP: Number of tangential modules 
#define N_MOD_z                 4 // RatCAP: Number of axial modules
#define N_CRYSTAL              32 // RatCAP: Number of crystals 8x4
#define N_CRY_xy                8 // RatCAP: Number of tangential crystals 
#define N_CRY_z                 4 // RatCAP: Number of axial crystals
#define MAX_D_RING             15 // RatCAP: Maximum ring difference
#define USE_OFFSET		0 // RatCAP: On/off use of offset
#define OFFSET                 99 // RatCAP: Sets initial sinogram angle
