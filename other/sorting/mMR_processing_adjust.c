...
//
//######################################################################################
//# Program   : mMR_processing.c                                                  #
//# Modified by Michael Salerno for Siemens Biograph mMR geometry in Stony Brook University        #
//# Jan, 2016, NY, USA                                                                 #
...
#define N_SEG                  121 // mMR: Number of segments (2 * N_RINGS - 1)
#define N_DET                 448 // mMR: Detectors per ring
#define S_WIDTH               447 // mMR: Number of radial sinogram bins
#define N_RSEC                 56 // mMR: Number of rsector
#define N_MODULE                8 // mMR: Number of modules 1x4
#define N_MOD_xy                1 // mMR: Number of tangential modules 
#define N_MOD_z                 2 // mMR: Number of axial modules
#define N_CRYSTAL              64 // mMR: Number of crystals 8x8
#define N_CRY_xy                8 // mMR: Number of tangential crystals 
#define N_CRY_z                 8 // mMR: Number of axial crystals
#define MAX_D_RING             60 // mMR: Maximum ring difference
#define USE_OFFSET		0 // mMR: On/off use of offset
#define OFFSET                 0 // mMR: Sets initial sinogram angle
...
//#####################################################################
  ...
  for (Int_t i = 0 ; i < nentries ; i++)
      ...
      if (USE_OFFSET == 1)
	{
      ...
      if(phi>N_DET/4) phi = phi-N_DET/4; //offset
      else phi = phi+N_DET/4;   //offset           
